...
::: {style="font-size: 0.7em; color: #666; text-align: center;"}
Langur monkeys grieve over a robot spy monkey.
:::
:::
::::
...
:::
::: {.column width="50%"}
![TikTok — 1 million views explaining psychology of deception with Dougal the dog](assets/images/slides/tiktok-famous.jpg){fig-alt="TikTok famous" width="100%"}
...
:::: {.columns}
::: {.column width="50%"}
![The Goldsmiths Great Hall became a courtroom, a crime scene, and an 80s disco](assets/images/slides/fpu-80s-event.png){fig-alt="FPU 80s event" width="100%"}
:::
::: {.column width="50%"}
