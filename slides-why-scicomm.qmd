...
::: {style="font-size: 0.7em; color: #666; text-align: center;"}
Little monkeys making mischief! 
:::
:::
::::
...
Primatologist, conservationist, and one of the most recognisable scientists alive.

Goodall's genius was not just the fieldwork — it was making people *care*. She gave the chimps names. She told their stories as individuals. She broke the rules of detached scientific reporting and, in doing so, built a global movement.

Her late career is entirely science communication: talks, books, the Jane Goodall Institute, Roots & Shoots. The research became the platform. The communication became the mission.
...
:::: {.columns}
::: {.column width="50%"}
![BBC Horizon: A Week Without Lying — The Honesty Experiment](assets/images/slides/honesty-experiment.png){fig-alt="Horizon honesty experiment" width="100%"}

![The One Show — live BBC studio, explaining deception research](assets/images/slides/oneshow.jpg){fig-alt="Gordon on The One Show" width="100%"}
:::
::: {.column width="50%"}
![TikTok — 1 million views explaining psychology of profiling with Dougal the dog](assets/images/slides/tiktok-famous.jpg){fig-alt="TikTok famous" width="100%"}

![With Beth Loftus — memory researcher, courtroom expert, science communicator](assets/images/slides/gordon-beth.jpg){fig-alt="Gordon and Beth Loftus" width="100%"}
:::
::::
...
**BBC Horizon** — 60 minute documentary. Millions of viewers. I had to explain the psychology of deception to a general audience while participating in an experiment on camera.

**The One Show** — Live BBC studio. 4 minutes. No second takes. You either communicate clearly or you do not.
...
**Journalism** — quoted in newspapers, on radio, in podcasts.
...
At Goldsmiths, the Forensic Psychology Unit turned science communication into something nobody expected: **immersive crime events**.
...
:::: {.columns}
::: {.column width="50%"}
![The Goldsmiths Great Hall became a courtroom, St. James a crime scene, and an 80s disco](assets/images/slides/fpu-80s-event.png){fig-alt="FPU 80s event" width="100%"}
:::
::: {.column width="50%"}
...
These events were created by **psychology staff and students**. The research was real. The communication was theatrical. The audience learned without realising they were being taught.

**That is science communication at its most ambitious.**
...
Feynman used a glass of ice water. Sagan used a photograph of Earth. Attenborough used a robot monkey. Loftus used Bugs Bunny. We used a courtroom in the Great Hall.
...
## You may consider using R for your blog post...

<!-- TODO: Replace LOOM_VIDEO_ID with the actual Loom share ID once recorded.
     Uncomment the slide below to enable the full-page video embed.

---

## Watch: creating and publishing a blog post {background-iframe="https://www.loom.com/embed/LOOM_VIDEO_ID" background-interactive="true"}
